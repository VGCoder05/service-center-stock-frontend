...
const Navbar = ({ user, logout }) => {
  ...
  const Links = [
    ...
    { to: '/reports', label: 'Reports', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
  ...
  const NavLink = ({ to, children }) => {
    ...
    return (
      <Link
        to={to}
        className={`overflow-hidden relative px-3 py-2 text-sm font-medium text-gray-600 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            >
              {/* Logout */}
              <svg className="w-max h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
